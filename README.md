...
* single html
* no dependence - uses vanilla javascript
* supports all browsers
* dark mode or dark theme
* responsive, supports mobile
* customized theme (by css style)

### Usage Guide

simply copy [index.html](https://github.com/casualwriter/casual-markdown-page/blob/main/source/index.html) to a web server, or fork this repo. 

* configure the site at index.md (title, subtitle, header-color, navigation, etc..)
